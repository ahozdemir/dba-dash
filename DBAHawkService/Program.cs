    ...
    internal class Program
    {
        ...
        private static void Startup(string[] args)
        {
            ...
            if (Upgrade.IsUpgradeIncomplete)
            {
                const string message =
                    $"Incomplete upgrade of DBA Hawk detected.  File '{Upgrade.UpgradeFile}' found in directory. Upgrade might have failed due to locked files. More info: https://dbadash.com/upgrades/";
        ...
        private static void SetupLogging()
        {
            ...
            Log.Logger = new LoggerConfiguration()
                ...
                .Enrich.WithProperty("ApplicationName", "DBAHawk")
