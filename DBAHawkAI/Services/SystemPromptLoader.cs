...
namespace DBAHawkAI.Services
{
    ...
    ///   3. The embedded resource <c>DBAHawkAI.Prompts.system-prompt.txt</c> compiled into
    ...
    public class SystemPromptLoader
    {
        ...
        private const string EmbeddedResourceName = "DBAHawkAI.Prompts.system-prompt.txt";
