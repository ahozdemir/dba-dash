...
namespace DBAHawkAI.Services
{
    public class AiRiskForecastService
    {
        private readonly AiRunbookLinkService _runbookLinkService;

        public AiRiskForecastService(AiRunbookLinkService runbookLinkService)
        {
            _runbookLinkService = runbookLinkService;
        }
