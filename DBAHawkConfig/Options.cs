...
CheckForUpdates - Check if a new version of DBA Hawk is available
Update - Update to the latest version of DBA Hawk
SetServiceName - Change the name of the DBA Hawk service
...
SetPerfmonCounters - Set OS-level (perfmon) counters.  Sets the global list, or a per-connection override when -c/--ConnectionID is supplied.  Use --PerfmonDefaults, --PerfmonCounters, --PerfmonClear and/or --PerfmonInherit.")]
        ...
        [Option("ServiceName", Default = "", Required = false, HelpText = "Use with -a SetServiceName to set the service name for the DBA Hawk service.")]
