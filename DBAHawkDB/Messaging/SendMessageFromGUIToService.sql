...
*/
DECLARE @Service NVARCHAR(128) = CONCAT('//dbadash.com/DBAHawkService/ComsTarget',@DBADashAgentID)
...
BEGIN DIALOG @InitDlgHandle 
	FROM SERVICE [//dbadash.com/DBAHawkService/ComsInit]
    TO SERVICE @Service
	ON CONTRACT [//dbadash.com/DBAHawkService/ComsContract] 
	WITH ENCRYPTION = OFF,RELATED_CONVERSATION_GROUP = @ConversationGroup,LIFETIME = @Lifetime;

SEND ON CONVERSATION @InitDlgHandle
        MESSAGE TYPE
        [//dbadash.com/DBAHawkService/Send]
        (@Payload);
