...
AS
/* 
	Ensure only a single instance of the DBA Hawk service is processing alerts at one time
*/
...
WHERE ID = 1
AND (LockUpdated < DATEADD(mi,-10,SYSUTCDATETIME()) /* Lock will expire after 10min allowing another DBA Hawk service to take over alert processing */
