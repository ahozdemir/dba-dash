    ...
    public partial class ConfigureDisplayName : Form
    {
        ...
        private void SetCols()
        {
            ...
            dgv.Columns.AddRange(
                new DataGridViewTextBoxColumn() { Name = "colConnectionID", DataPropertyName = "ConnectionID", HeaderText = "ConnectionID", ReadOnly = true, DefaultCellStyle = new DataGridViewCellStyle() { BackColor = HawkColors.GrayLight, ForeColor = Color.Black } },
                new DataGridViewTextBoxColumn() { DataPropertyName = "Instance", HeaderText = "Instance", ReadOnly = true, DefaultCellStyle = new DataGridViewCellStyle() { BackColor = HawkColors.GrayLight, ForeColor = Color.Black } },
