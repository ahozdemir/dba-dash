...
namespace DBAHawkGUI.Charts
{
    ...
    internal static class ChartTooltipHelper
    {
        ...
        private class TooltipForm : Form
        {
            ...
            public TooltipForm()
            {
                ...
                _borderPanel = new Panel
                {
                    AutoSize = true,
                    AutoSizeMode = AutoSizeMode.GrowAndShrink,
                    BackColor = HawkColors.GrayLight,
        ...
        private static Color GetSeriesColor(ISeries series)
        {
            ...
            // Default to HawkBlue if color can't be determined
            return HawkColors.HawkBlue;
        }
