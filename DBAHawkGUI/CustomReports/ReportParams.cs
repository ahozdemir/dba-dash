    ...
    public partial class ReportParams : Form
    {
        ...
        private void ReportParams_Load(object sender, EventArgs e)
        {
            dgv.Columns.AddRange(
                new DataGridViewTextBoxColumn() { Name = "ParamName", HeaderText = "Parameter Name", ReadOnly = true, Width = 200, DefaultCellStyle = { BackColor = HawkColors.NotApplicable, ForeColor = Color.Black } },
