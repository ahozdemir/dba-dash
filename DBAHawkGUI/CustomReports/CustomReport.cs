    ...
    public class SimpleBinder : DefaultSerializationBinder
    {
        ...
        public override Type BindToType(string assemblyName, string typeName)
        {
            ...
            if (!string.IsNullOrWhiteSpace(typeName))
            {
                ...
                if (type == null)
                {
                    // Chart-specific types live in the DBAHawkGUI.Charts namespace
                    type = currentAssembly.GetType($"DBAHawkGUI.Charts.{typeName}");
                }
                ...
                if (type == null)
                {
                    type = currentAssembly.GetType($"DBAHawkGUI.{typeName}");
                }

                if (type == null)
                {
                    type = currentAssembly.GetType($"DBAHawkGUI.Performance.{typeName}");
                }

                if (type == null)
                {
                    type = currentAssembly.GetType($"DBAHawkGUI.SavedView.{typeName}");
                }
            }
