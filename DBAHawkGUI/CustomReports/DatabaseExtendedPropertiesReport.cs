            ...
            {
                {
                    0, new CustomReportResult
                    {
                        ...
                        {
                            { "InstanceID", new ColumnMetadata { Visible = false, Description = "DBA Hawk instance identifier" } },
                            { "DatabaseID", new ColumnMetadata { Visible = false, Description = "DBA Hawk database identifier" } },
