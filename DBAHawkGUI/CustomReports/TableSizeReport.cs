...
namespace DBAHawkGUI.CustomReports
{
    internal class TableSizeReport
    {
        public static SystemReport Instance => new()
        {
            ...
            TriggerCollectionTypes = { DBAHawk.CollectionType.TableSize.ToString() },
            SchemaName = "dbo",
                    ...
                    0, new CustomReportResult
                    {
                        ...
                        Columns = new Dictionary<string, ColumnMetadata>
                        {
                            { "ObjectID", new ColumnMetadata {
                                Visible = false,
                                Description = "DBA Hawk object identifier for the table dbo.DBObjects"
                            }},
                            { "InstanceID", new ColumnMetadata {
                                Visible = false,
                                Description = "DBA Hawk instance identifier dbo.Instances"
                            }},
