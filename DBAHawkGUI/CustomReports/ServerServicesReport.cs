...
namespace DBAHawkGUI.CustomReports
{
    public class ServerServicesReport
    {
        public static SystemReport Instance => new()
        {
            ...
            TriggerCollectionTypes = { DBAHawk.CollectionType.ServerServices.ToString() },
                    ...
                    0, new CustomReportResult
                    {
                        ...
                        Columns = new Dictionary<string, ColumnMetadata>
                        {
                            { "InstanceID", new ColumnMetadata {
                                Alias = "Instance ID",
                                Visible = false,
                                Description = "DBA Hawk instance identifier from dbo.Instances"
                            }},
                            ...
                            { "instant_file_initialization_enabled_status", new ColumnMetadata {
                                ...
                                Visible = false,
                                Highlighting = new CellHighlightingRuleSet("instant_file_initialization_enabled_status") { IsStatusColumn = true },
                                Description = "DBA Hawk status value for instant file initialization"
                            }},
