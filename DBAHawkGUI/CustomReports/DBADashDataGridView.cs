...
namespace DBAHawkGUI.CustomReports
{
    public class DBADashDataGridView : DataGridView
    {
        ...
        private void FreezeColumn()
        {
            ...
            {
                column.HeaderCell.Style.BackColor = column.Frozen ? HawkColors.BluePale : Color.Empty;
                column.HeaderCell.Style.ForeColor = column.Frozen ? HawkColors.HawkBlueDark : Color.Empty;
            }
        }
...
|                                                        |
|	    SQL Server Monitoring by Ahmet Ozdemir			 |
|       Copyright (c) 2026 datacomware					 |
|		https://dbadash.com								 |
