    ...
    public partial class RunningQueries : UserControl, INavigation, ISetContext, IRefreshData, ISetStatus
    {
        ...
        private async Task ProcessPlanCollectionMessageReply(ResponseMessage reply, Guid messageGroup, SetStatusDelegate setStatus)
        {
            try
            {
                ...
                SetStatus("Loading Plan...", string.Empty, HawkColors.Information);
                ...
                {
                    SetStatus("Query plan was not found", string.Empty, HawkColors.Fail);
                ...
                var statusColor = HawkColors.Green;
                try
                {
                ...
                catch (Exception ex)
                {
                    ...
                    tooltip = ex.Message;
                    statusColor = HawkColors.Warning;
                }
            ...
            {
                SetStatus(ex.Message, ex.ToString(), HawkColors.Red);
            }
        }
        ...
        private void CollectPlan(DataRowView row, DBADashContext context)
        {
            if (context.CanMessage)
            {
                try
                {
                    ...
                    SetStatus("Plan collection message SENT", string.Empty, HawkColors.Information);
                }
                catch (Exception ex)
                {
        ...
        {
            tsEditLimit.LinkColor = HawkColors.LinkColor;
