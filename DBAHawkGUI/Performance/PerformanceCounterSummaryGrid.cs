...
using static DBAHawkGUI.DBADashStatus;
...
namespace DBAHawkGUI.Performance
{
    public class PerformanceCounterSummaryGrid : DBADashDataGridView
    {
        ...
        private void AddCols()
        {
            ...
            Columns.AddRange(
                new DataGridViewLinkColumn() { Name = "lnkObject", HeaderText = "Object", DataPropertyName = "object_name", LinkColor = HawkColors.LinkColor, Visible = ObjectLink, SortMode = DataGridViewColumnSortMode.Automatic },
                new DataGridViewLinkColumn() { Name = "lnkCounter", HeaderText = "Counter", DataPropertyName = "counter_name", LinkColor = HawkColors.LinkColor, Visible = CounterLink, SortMode = DataGridViewColumnSortMode.Automatic },
                new DataGridViewLinkColumn() { Name = "lnkInstance", HeaderText = "Instance", DataPropertyName = "instance_name", LinkColor = HawkColors.LinkColor, Visible = InstanceLink, SortMode = DataGridViewColumnSortMode.Automatic },
                ...
                new DataGridViewLinkColumn() { Name = "lnkThresholds", HeaderText = "Thresholds", Text = "Edit", LinkColor = HawkColors.LinkColor, UseColumnTextForLinkValue = true },
                new DataGridViewLinkColumn() { Name = "lnkView", HeaderText = "Chart", Text = "View", LinkColor = HawkColors.LinkColor, UseColumnTextForLinkValue = true, ToolTipText = "Click to view chart." }
            );
        }
