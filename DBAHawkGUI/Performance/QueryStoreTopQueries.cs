...
using static DBAHawkGUI.Messaging.MessagingHelper;
    ...
    public partial class QueryStoreTopQueries : UserControl, ISetContext, IRefreshData, ISetStatus
    {
        ...
        public async void RefreshData()
        {
            ...
            try
            {
                ...
                lblStatus.InvokeSetStatus(messageSentMessage, string.Empty, HawkColors.Information);
            ...
            {
                lblStatus.InvokeSetStatus(ex.Message.Truncate(200), ex.ToString(), HawkColors.Fail);
            }
        }
        ...
        private Task ProcessCompletedTopQueriesOrDrillDownMessage(ResponseMessage reply, DataGridView _dgv, List<KeyValuePair<string, PersistedColumnLayout>> layout)
        {
            ...
            {
                ResponseMessage.ResponseTypes.Success => HawkColors.Success,
                ResponseMessage.ResponseTypes.Progress => HawkColors.Information,
                _ => HawkColors.Fail
            });
            ...
            Invoke(() =>
            {
                ...
                {
                    lblStatus.InvokeSetStatus("Error loading column layout", ex.Message, HawkColors.Fail);
                }
        ...
        private async Task ProcessPlanForcingMessage(ResponseMessage reply, Guid messageGroup, SetStatusDelegate setStatus)
        {
            ...
            {
                lblStatus.InvokeSetStatus("Plan Forcing Operation Completed", string.Empty, HawkColors.Success);
            ...
            {
                lblStatus.InvokeSetStatus("Plan Forcing Operation Failed", reply.Message, HawkColors.Fail);
