    ...
    public partial class MemoryUsage : UserControl, ISetContext, IRefreshData
    {
        ...
        private void ShowPie(ref DataTable dt)
        {
                ...
                if (pct > 0.02)
                {
                    var s = new PieSeries<double>
                    {
                        ...
                        DataLabelsPaint = showDataLabels
                            ? new SolidColorPaint(HawkColors.White.ToSKColor()) { StrokeThickness = 2 }
                            : null,
            ...
            if (other > 0)
            {
                var s = new PieSeries<double>
                {
                    Name = "{Other}",
                    Values = new[] { other },
                    DataLabelsPaint = new SolidColorPaint(HawkColors.White.ToSKColor()) { StrokeThickness = 2 },
        ...
        private void ShowMemoryUsageForClerk(string format = "N0")
        {
            ...
            var labelPaint = DBADashUser.SelectedTheme.ThemeIdentifier == ThemeType.Dark
                ? new SolidColorPaint(HawkColors.White.ToSKColor())
                : new SolidColorPaint(HawkColors.HawkBlueDark.ToSKColor());
