    ...
    public partial class ObjectExecutionSummary : UserControl, ISetContext, IRefreshData
    {
        ...
        private readonly List<DataGridViewColumn> StandardCols = new()
        {
            new DataGridViewTextBoxColumn() { Name = "DB", DataPropertyName = "DB",DisplayIndex=0 },
                                                                        ...
                                                                        new DataGridViewLinkColumn { Name = "Name", DataPropertyName = "ObjectName",DisplayIndex=2, SortMode = DataGridViewColumnSortMode.Automatic, LinkColor = HawkColors.LinkColor},
        ...
        public List<DataGridViewColumn> Columns
        {
            get
            {
                ...
                foreach (var col in Cols)
                {
                    ...
                    compareCol.DefaultCellStyle.ForeColor = HawkColors.HawkBlue;
        ...
        private static Color DiffColorFromDouble(double value)
        {
            ...
            {
                > 0.5 => HawkColors.Red,
                > 0.3 => HawkColors.RedLight,
                < -0.5 => HawkColors.Success,
                < -0.3 => HawkColors.GreenLight,
                _ => HawkColors.BlueLight
            };
        }
