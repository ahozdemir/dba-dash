...
namespace DBAHawkGUI.Tagging
{
    public partial class Tags : UserControl, INavigation, ISetContext, IThemedControl
    {
        ...
        private void RefreshReport()
        {
            ...
            dgvReport.Columns.Add(new DataGridViewLinkColumn() { HeaderText = "Instance", DataPropertyName = "Instance", SortMode = DataGridViewColumnSortMode.Automatic, LinkColor = HawkColors.LinkColor, Frozen = Common.FreezeKeyColumn });
