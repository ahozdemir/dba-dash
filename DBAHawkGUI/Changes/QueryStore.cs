...
namespace DBAHawkGUI.Changes
{
    public partial class QueryStore : UserControl, INavigation, ISetContext
    {
        ...
        {
            dgv.Columns.Clear();
            dgv.Columns.Add(new DataGridViewLinkColumn() { Name = "colDB", HeaderText = "DB", DataPropertyName = "name", LinkColor = HawkColors.LinkColor, Frozen = Common.FreezeKeyColumn, SortMode = DataGridViewColumnSortMode.Automatic, ToolTipText = "Database name" });
            ...
            dgv.Columns.Add(new DataGridViewTextBoxColumn() { HeaderText = "Interval Length (Min)", DataPropertyName = "interval_length_minutes", ToolTipText = "Statistics aggregation interval in minutes. Default 60 minutes." });
        ...
        {
            dgv.Columns.Clear();
            dgv.Columns.Add(new DataGridViewLinkColumn { Name = "colInstance", HeaderText = "Instance", DataPropertyName = "InstanceGroupName", LinkColor = HawkColors.LinkColor, Frozen = Common.FreezeKeyColumn, SortMode = DataGridViewColumnSortMode.Automatic });
