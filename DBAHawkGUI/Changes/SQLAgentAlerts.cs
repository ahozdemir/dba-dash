...
namespace DBAHawkGUI.Changes
{
    public partial class SQLAgentAlerts : UserControl, ISetContext
    {
        ...
        private static readonly DataGridViewColumn[] Cols ={
                new DataGridViewLinkColumn(){ Name="Acknowledge", HeaderText="Acknowledge", Text="Acknowledge", LinkColor = HawkColors.LinkColor, SortMode = DataGridViewColumnSortMode.Automatic},
                new DataGridViewLinkColumn(){ Name="Configure", HeaderText="Configure", Text="Configure", UseColumnTextForLinkValue=true,LinkColor = HawkColors.LinkColor, SortMode = DataGridViewColumnSortMode.Automatic},
