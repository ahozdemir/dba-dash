...
namespace DBAHawkGUI
{
    public class Common : CommonShared
    {
        ...
        public static string DDL(long DDLID)
        {
            ...
            return DBAHawk.SMOBaseClass.Unzip(bDDL);
        }
        ...
        {
            CopyDataGridViewToClipboard(dgv, HawkColors.HawkBlue, Color.White);
        }
        ...
        {
            headerBGcolor ??= HawkColors.HawkBlue;
            headerColor ??= HawkColors.White;
        ...
        public static void SaveDataGridViewsToXLSX(DataGridView[] Grids, string path, bool replaceInvalidChars = false)
        {
            ...
            foreach (var dgv in Grids)
            {
                ...
                header.Style.Fill.SetBackgroundColor(XLColor.FromColor(HawkColors.HawkBlue));
        ...
        public static int[] GetCustomColors()
        {
            return new[]
            {
                HawkColors.Warning.ToWin32(),
                HawkColors.Yellow.ToWin32(),
                HawkColors.YellowLight.ToWin32(),
                HawkColors.Fail.ToWin32(),
                HawkColors.Red.ToWin32(),
                HawkColors.RedLight.ToWin32(),
                HawkColors.RedPale.ToWin32(),
                HawkColors.Success.ToWin32(),
                HawkColors.Green.ToWin32(),
                HawkColors.GreenLight.ToWin32(),
                HawkColors.Information.ToWin32(),
                HawkColors.HawkBlue.ToWin32(),
                HawkColors.HawkBlueDark.ToWin32(),
                HawkColors.HawkGray.ToWin32(),
                HawkColors.GrayLight.ToWin32(),
                HawkColors.AvoidanceZone.ToWin32(),
                HawkColors.BluePale.ToWin32(),
            };
        }
        ...
        public static void HighlightGridDifferences(DataGridView grid1, DataGridView grid2)
        {
            ...
            var highlightBackColor = HawkColors.RedPale;
            var highlightForeColor = HawkColors.HawkGray;
