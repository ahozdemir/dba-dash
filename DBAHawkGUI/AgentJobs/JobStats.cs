...
namespace DBAHawkGUI.AgentJobs
{
    public partial class JobStats : UserControl, ISetContext, IRefreshData, INavigation
    {
        ...
        private void JobStats_Load(object sender, EventArgs e)
        {
            ...
            dgv.Columns.Add(new DataGridViewLinkColumn() { Name = "colJob", HeaderText = "Job", DataPropertyName = "JobName", SortMode = DataGridViewColumnSortMode.Automatic, LinkColor = HawkColors.LinkColor });
            ...
            dgv.Columns.Add(new DataGridViewLinkColumn() { Name = "colView", HeaderText = "View", Text = "View", UseColumnTextForLinkValue = true, LinkColor = HawkColors.LinkColor });
