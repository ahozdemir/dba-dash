...
{           new DataGridViewTextBoxColumn(){ Name="Instance", HeaderText="Instance", DataPropertyName="InstanceGroupName", SortMode = DataGridViewColumnSortMode.Automatic},
            ...
            new DataGridViewLinkColumn() { Name = "MoreInfo",HeaderText = "More Info",Text="More Info", UseColumnTextForLinkValue = true, LinkColor = HawkColors.LinkColor, DefaultCellStyle = new DataGridViewCellStyle() { BackColor = Color.White, ForeColor = Color.Black}, ToolTipText = "Script to run on monitored SQL instance to get more information about detected corruption."},
            new DataGridViewLinkColumn() { Name = "Acknowledge",HeaderText = "Acknowledge",Text="Acknowledge", LinkColor = HawkColors.LinkColor, DefaultCellStyle = new DataGridViewCellStyle() { BackColor = Color.White, ForeColor = Color.Black}, ToolTipText = "Click link to acknowledge issue after taking steps to identify the root cause of the corruption, repair if necessary and validate that the database is free of corruption."}
        };
