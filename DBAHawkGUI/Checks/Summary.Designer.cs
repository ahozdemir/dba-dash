...
namespace DBAHawkGUI
{
    partial class Summary
    {
        ...
        private void InitializeComponent()
        {
            ...
            tsSummaryMaxHeight = new System.Windows.Forms.ToolStripMenuItem();
            ...
            dataGridViewCellStyle7.BackColor = System.Drawing.Color.FromArgb(241, 241, 246);
            dataGridViewCellStyle7.Font = new System.Drawing.Font("Segoe UI", 9F);
            dataGridViewCellStyle7.ForeColor = System.Drawing.Color.FromArgb(0, 79, 131);
            dataGridViewCellStyle7.SelectionBackColor = System.Drawing.Color.FromArgb(211, 211, 216);
            dataGridViewCellStyle7.SelectionForeColor = System.Drawing.Color.FromArgb(0, 79, 131);
            ...
            MemoryDumpStatus.ToolTipText = "Time since last memory dump. Configure or Clear status using Options\\Memory Dumps from the toolbar";
            MemoryDumpStatus.Width = 70;
            // 
            // CorruptionStatus
            // 
            CorruptionStatus.HeaderText = "Corruption";
            CorruptionStatus.LinkColor = System.Drawing.Color.FromArgb(0, 79, 131);
            ...
            CorruptionStatus.Text = "";
            CorruptionStatus.ToolTipText = "Time since last corruption detection from msdb.dbo.suspect_pages, sys.dm_hadr_auto_page_repair & sys.dm_db_mirroring_auto_page_repair.  Click link in grid to acknowledge.";
            CorruptionStatus.Width = 75;
            // 
            // LastGoodCheckDBStatus
            // 
            LastGoodCheckDBStatus.HeaderText = "Last Good Check DB";
            LastGoodCheckDBStatus.LinkColor = System.Drawing.Color.FromArgb(0, 79, 131);
            ...
            LastGoodCheckDBStatus.Text = "";
            LastGoodCheckDBStatus.ToolTipText = "Oldest time since last good check DB across all databases.  Click the link and use the gear icon on the Last Good CheckDB tab to configure thresholds and exclusions.";
            LastGoodCheckDBStatus.Width = 70;
            // 
            // AlertStatus
            // 
            AlertStatus.HeaderText = "SQL Agent Alerts";
            AlertStatus.LinkColor = System.Drawing.Color.FromArgb(0, 79, 131);
            ...
            AlertStatus.ToolTipText = "Time since last occurrence of a SQL Server agent alert.  Click the link and configure/acknowledge on the SQL Server Agent Alerts tab.";
            AlertStatus.Width = 70;
            // 
            // FullBackupStatus
            // 
            FullBackupStatus.HeaderText = "Backup FULL";
            FullBackupStatus.LinkColor = System.Drawing.Color.FromArgb(0, 79, 131);
            ...
            FullBackupStatus.ToolTipText = "Highlights if any database is missing a recent FULL backup.  Click cell to load Backups tab.  Configure thresholds and exclusions on the Backups tab.";
            FullBackupStatus.Width = 70;
            // 
            // DiffBackupStatus
            // 
            DiffBackupStatus.HeaderText = "Backup DIFF";
            DiffBackupStatus.LinkColor = System.Drawing.Color.FromArgb(0, 79, 131);
            ...
            DiffBackupStatus.ToolTipText = "Highlights if any database is missing a recent DIFF backup.  Click cell to load Backups tab.  Configure thresholds and exclusions on the Backups tab.";
            DiffBackupStatus.Width = 70;
            // 
            // LogBackupStatus
            // 
            LogBackupStatus.HeaderText = "Backup LOG";
            LogBackupStatus.LinkColor = System.Drawing.Color.FromArgb(0, 79, 131);
            ...
            LogBackupStatus.ToolTipText = "Highlights if any database is missing a recent LOG backup.  Click cell to load Backups tab.  Configure thresholds and exclusions on the Backups tab.";
            LogBackupStatus.Width = 70;
            // 
            // DriveStatus
            // 
            DriveStatus.HeaderText = "Drive Space";
            DriveStatus.LinkColor = System.Drawing.Color.FromArgb(0, 79, 131);
            ...
            DriveStatus.ToolTipText = "Highlights if any drives are low on space.  Click cell to load Drives tab.  Configure thresholds and exclusions on the drives tab.";
            DriveStatus.Width = 70;
            // 
            // JobStatus
            // 
            JobStatus.HeaderText = "Agent Jobs";
            JobStatus.LinkColor = System.Drawing.Color.FromArgb(0, 79, 131);
            ...
            JobStatus.ToolTipText = "Highlights if there are recent SQL Agent job failures.  Click cell to load Job Status tab.  Configure thresholds and exclusions on the Job Status tab.";
            JobStatus.Width = 70;
            // 
            ...
            IsAgentRunningStatus.ToolTipText = "Highlights if the SQL Agent is not running.  Check can be configured on the Job Status tab under the Jobs node in the tree.";
            IsAgentRunningStatus.Width = 70;
            // 
            // LogShippingStatus
            // 
            LogShippingStatus.HeaderText = "Log Shipping";
            LogShippingStatus.LinkColor = System.Drawing.Color.FromArgb(0, 79, 131);
            ...
            LogShippingStatus.ToolTipText = "Highlights databases in a restoring or standby state that haven't had a recent log backup applied.  Click to load Log Shipping tab.  Configure thresholds and exclusions on the Log Shipping tab.";
            ...
            MirroringStatus.ToolTipText = "Highlights issues with database mirroring based on reported mirroring_state & mirroring_witness_state from sys.database_mirroring";
            MirroringStatus.Width = 70;
            // 
            // AGStatus
            // 
            AGStatus.HeaderText = "Availability Groups";
            AGStatus.LinkColor = System.Drawing.Color.FromArgb(0, 79, 131);
            ...
            AGStatus.Text = "";
            AGStatus.ToolTipText = "Highlights issues with availability groups.  Click cell to load Availability Groups tab for more info.";
            AGStatus.Width = 80;
            // 
            // LogFreeSpaceStatus
            // 
            LogFreeSpaceStatus.HeaderText = "Log Space";
            LogFreeSpaceStatus.LinkColor = System.Drawing.Color.FromArgb(0, 79, 131);
            ...
            LogFreeSpaceStatus.ToolTipText = "Highlights log files with low internal free space.  Click to load Files tab.  Configure thresholds and exclusions on the Files tab.";
            ...
            FileFreeSpaceStatus.LinkColor = System.Drawing.Color.FromArgb(0, 79, 131);
            ...
            FileFreeSpaceStatus.ToolTipText = "Highlights database files with low free space.  Click to load Files tab.  Configure thresholds and exclusions on the Files tab.";
            ...
            PctMaxSizeStatus.LinkColor = System.Drawing.Color.FromArgb(0, 79, 131);
            ...
            PctMaxSizeStatus.ToolTipText = "Highlights database files that are close to their max size.  Click cell to load Files tab.  Configure thresholds and exclusions on the Files tab.";
            ...
            ElasticPoolStorageStatus.LinkColor = System.Drawing.Color.FromArgb(0, 79, 131);
            ...
            ElasticPoolStorageStatus.ToolTipText = "Highlights Azure DB elastic pools that are running out of allocated storage.  Click cell to load Azure Summary tab.";
            ElasticPoolStorageStatus.Width = 70;
            // 
            // QueryStoreStatus
            // 
            QueryStoreStatus.HeaderText = "QS";
            QueryStoreStatus.LinkColor = System.Drawing.Color.FromArgb(0, 79, 131);
            ...
            QueryStoreStatus.ToolTipText = "Highlights issues with query store where the desired state does not match the actual state.";
            ...
            CustomCheckStatus.LinkColor = System.Drawing.Color.FromArgb(0, 79, 131);
            ...
            CustomCheckStatus.ToolTipText = "The status of your own custom checks. https://dbadash.com/docs/help/custom-checks/";
            ...
            CollectionErrorStatus.HeaderText = "DBA Hawk Errors (24hrs)";
            CollectionErrorStatus.LinkColor = System.Drawing.Color.FromArgb(0, 79, 131);
            ...
            CollectionErrorStatus.ToolTipText = "Count of errors encountered by the DBA Hawk service during data collection or import for the instance.  Retries are highlighted as warning, failures are critical.";
            CollectionErrorStatus.Width = 70;
            // 
            // SnapshotAgeStatus
            // 
            SnapshotAgeStatus.HeaderText = "Snapshot Age";
            SnapshotAgeStatus.LinkColor = System.Drawing.Color.FromArgb(0, 79, 131);
            ...
            SnapshotAgeStatus.ToolTipText = "Highlights if the expected collection date for any collection exceeds the specified threshold.  Click to load the Collection Dates tab to view collection dates and configure thresholds.";
            ...
            DBMailStatus.ToolTipText = "Highlights based on status of DB Mail (from msdb.dbo.sysmail_help_status_sp)";
            ...
            IdentityStatus.LinkColor = System.Drawing.Color.FromArgb(0, 79, 131);
            ...
            DatabaseStateStatus.LinkColor = System.Drawing.Color.FromArgb(0, 79, 131);
            ...
            UptimeStatus.LinkColor = System.Drawing.Color.FromArgb(0, 79, 131);
            ...
            // 
            dataGridViewTextBoxColumn15.HeaderText = "DBAHawk Errors";
        ...
        private System.Windows.Forms.ToolStripMenuItem tsSummaryMaxHeight;
