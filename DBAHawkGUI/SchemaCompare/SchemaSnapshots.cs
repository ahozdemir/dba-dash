...
using static DBAHawkGUI.DiffControl;
...
namespace DBAHawkGUI.Changes
{
    public partial class SchemaSnapshots : UserControl, INavigation, ISetContext, ISetStatus
    {
        ...
        private async Task TriggerSchemaSnapshot(DataRowView row)
        {
            ...
            {
                SetStatus("Collections can't be triggered for this instance.", "Enable messaging in the service configuration tool to allow communication", HawkColors.Warning);
            }
        }
