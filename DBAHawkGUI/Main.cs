...
using DBAHawkGUI.Changes;
using DBAHawkGUI.Checks;
using DBAHawkGUI.CustomReports;
using DBAHawkGUI.DBADashAlerts;
using DBAHawkGUI.Options_Menu;
using DBAHawkGUI.Performance;
using DBAHawkGUI.Properties;
...
namespace DBAHawkGUI
{
    public partial class Main : Form, IMessageFilter, IThemedControl
    {
        ...
        private async void Main_Load(object sender, EventArgs e)
        {
                ...
                )
            {
                        ...
                        .ServiceConfigToolName)) // The service configuration tool exists (Not the GUI only package).  Give user the option to configure the service or connect to an existing repository.
                {
                    ...
                    {
                        // Prompt the user to connect to an existing DBA Hawk repository DB.
        ...
        private async void TsConnect_Click(object sender, EventArgs e)
        {
            ...
            {
                CommonShared.ShowExceptionDialog(ex, "Error switching to DBA Hawk repository database");
            }
        }
        ...
        private void InitializeNotifyIcon()
        {
            notifyIcon = new NotifyIcon
            {
                ...
                Visible = true,
                Text = @"DBA Hawk Alert Notification"
            };
        }
        ...
        {
            DBAHawkSharedGUI.ExtensionMethods.ChildFormSingleInstance = singleInstance;
