...
namespace DBAHawkGUI
{
    ...
    public abstract class SavedView
    {
        ...
        public void Save()
        {
            ...
            using (var cmd = new SqlCommand("DBAHawk.SavedViews_Upd", cn) { CommandType = System.Data.CommandType.StoredProcedure })
            {
                cn.Open();
        ...
        public void Delete()
        {
            ...
            using (var cn = new SqlConnection(Common.ConnectionString))
            using (var cmd = new SqlCommand("DBAHawk.SavedViews_Del", cn) { CommandType = System.Data.CommandType.StoredProcedure })
            {
                cn.Open();
                cmd.Parameters.AddWithValue("Name", Name);
                cmd.Parameters.AddWithValue("ViewType", Type);
        ...
        {
            using (var cn = new SqlConnection(Common.ConnectionString))
            using (var cmd = new SqlCommand("DBAHawk.SavedViews_Get", cn) { CommandType = System.Data.CommandType.StoredProcedure })
            {
                cn.Open();
                cmd.Parameters.AddWithValue("UserID", UserID);
                cmd.Parameters.AddWithValue("ViewType", type);
