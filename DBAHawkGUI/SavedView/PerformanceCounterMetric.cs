...
namespace DBAHawkGUI
{
    ...
    public class PerformanceCounterMetric : IMetric
    {
        ...
        public int CounterID
        {
            ...
            set
            {
                if (Counters == null) Counters = new List<DBAHawkGUI.Performance.Counter>();
                if (Counters.Count == 0) Counters.Add(new DBAHawkGUI.Performance.Counter() { CounterID = value, CounterName = string.Empty });
