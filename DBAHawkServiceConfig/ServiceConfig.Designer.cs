...
namespace DBAHawkServiceConfig
{
    partial class ServiceConfig
    {
        ...
        private void InitializeComponent()
        {
            ...
            toolTip1.SetToolTip(bttnConnectSource, "Connect to a SQL Instance to monitor with DBA Hawk");
            ...
            toolTip1.SetToolTip(bttnConnect, "Connect to a SQL Instance that will store your DBA Hawk repository database");
            ...
            toolTip1.SetToolTip(lnkStop, "Stop the DBA Hawk service");
            ...
            toolTip1.SetToolTip(lnkStart, "Start the DBA Hawk service");
            ...
            toolTip1.SetToolTip(lnkRefresh, "Refresh the status of the DBA Hawk service");
