...
public partial class ServiceConfig
{
    ...
    /// <summary>
    /// Path to the appsettings.json for DBAHawkAI, expected alongside this tool.
    /// </summary>
    ...
    private void InitializeAiServiceControls()
    {
        ...
        toolTip1.SetToolTip(lnkStartAi, "Start the DBAHawkAI service");
        ...
        toolTip1.SetToolTip(lnkStopAi, "Stop the DBAHawkAI service");
        ...
        toolTip1.SetToolTip(lnkRefreshAi, "Refresh the DBAHawkAI service status");
        ...
        var grpService = new GroupBox
        {
            ...
            TabStop = false,
            Text = IsAdmin
                ? "DBAHawkAI Windows Service"
                : "DBAHawkAI Windows Service (Run as Administrator to manage)"
        };
