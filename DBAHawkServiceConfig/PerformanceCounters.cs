...
namespace DBAHawkServiceConfig
{
    public partial class PerformanceCounters : Form
    {
        ...
        private readonly DataTable defaultCounters = DBAHawk.PerformanceCounters.GetDefaultCountersDataTable();

        private async void PerformanceCounters_Load(object sender, EventArgs e)
        {
            try
            {
                dtSelected = DBAHawk.PerformanceCounters.PerformanceCountersDataTable();
                SetIsDefault();
        ...
        private async Task<DataTable> GetAvailableCountersAsync()
        {
            ...
            await using var cmd = new SqlCommand(DBAHawk.SqlStrings.AvailableCounters, cn);
            await cn.OpenAsync();
        ...
        private void Save_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                DBAHawk.PerformanceCounters.Save(dtSelected);
        ...
        private async void Preview_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                var dt = await DBCollector.GetPerformanceCountersDataTableAsync(ConnectionString, compatVersion, DBAHawk.PerformanceCounters.DataTableToXML(dtSelected));
                var frm = new Form()
                {
