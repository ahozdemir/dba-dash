namespace DBAHawkServiceConfig
{
    partial class TimeoutConfig
    {
        ...
        private void InitializeComponent()
        {
            ...
            themedTabControl1 = new DBAHawkGUI.Theme.ThemedTabControl();
            ...
            toolTip1.SetToolTip(chkAddPartitionsTimeout, "Timeout for adding new partitions.  Most data in DBA Hawk is partitioned which makes it efficient to remove data older than the configured retention");
        ...
        private DBAHawkGUI.Theme.ThemedTabControl themedTabControl1;
