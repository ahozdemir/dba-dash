...
namespace DBAHawkServiceConfig
{
    public partial class ScheduleConfig : Form
    {
        ...
        private void FormatRow(int idx)
        {
            ...
            {
                cell.Style.BackColor = cell.ReadOnly ? HawkColors.GrayLight : Color.White;
                cell.Style.SelectionBackColor = cell.ReadOnly ? HawkColors.HawkGray : HawkColors.BluePale;
                cell.Style.SelectionForeColor = HawkColors.White;
            }
