...
ORDER BY ProcName", cn);
        ...
        private void GetScript(string name, int retentionDays)
        {
            ...
            sb.AppendLine("|                                                        |");
            sb.AppendLine("|  DBA Hawk - Custom Collection Setup Script             |");
            ...
            sb.AppendLine("\tRun this script in your DBA Hawk repository database");
            sb.AppendLine(
            ...
            sb.AppendLine("(");
            sb.AppendLine(
                "\t/* Table-valued parameter passing a list of InstanceIDs (dbo.Instance table) associated with the current context in DBA Hawk */");
            ...
            if (usePartitions)
            {
                ...
                sb.AppendLine("(");
                sb.AppendLine("\t/* InstanceID associated with the current instance in DBA Hawk (dbo.Instances table) */");
                sb.AppendLine("\t@InstanceID INT,");
                sb.AppendLine("\t/* Show snapshots between @FromDate and @ToDate (UTC). DBA Hawk will supply these based on selected date range. */");
