...
namespace DBAHawkService
{
    ...
    public static class ScheduleInfoReporter
    {
            ...
            Dictionary<string, CustomCollection> effectiveCustomCollections, CollectionConfig config)
        {
            ...
            {
                // Normally already set when the source was added via the config tools (DBAHawkConfig/
            ...
            Dictionary<string, CustomCollection> effectiveCustomCollections)
        {
            ...
            var dtAgent = new DataTable("DBAHawk");
            ...
            // Tables["DBAHawk"].Rows[0]["Instance"]/["DBName"] before importing it - these columns aren't
