...
namespace DBAHawk
{
    public class Upgrade
    {
        ...
        public const string AuthorURL = "https://github.com/ahmetozdemir";
        public const string ServiceFileName = "DBAHawkService.exe";
        public const string UpgradeFile = "DBAHawk.Upgrade";
        public const string UpgradeLogFile = "DBAHawk.UpgradeLog.txt";
        public const string LocalScriptFile = "DBAHawk.LocalScript";
        public const string IncompleteUpgradeMessage = $"Incomplete upgrade of DBA Hawk detected.  File '{UpgradeFile}' found in directory. Upgrade might have failed due to locked files. More info: https://dbadash.com/upgrades/";
