...
using static DBAHawk.DBValidations;
...
EXECUTE sp_updateextendedproperty
                                    ...
                                    int retryCount = 0)
        {
            ...
            // Views/functions the user created outside of the DBA Hawk schema (e.g. a view in UserData
            // referencing a DBA Hawk table) can end up needing to be dropped as a side effect of an unrelated
            ...
            // Any object this error reports is - by definition - not part of the DBA Hawk model (objects that
            ...
            {
                var msg = "Encountered view(s)/function(s) outside of the DBA Hawk schema that must be dropped to apply this update. Attempting to remove and recreate them automatically.";
                MessageList.Add(msg);
                Log.Warning(ex, msg);
