...
namespace DBAHawk.Messaging
{
    public class SQSMessageProcessing
    {
        ...
        /// <param name="DBADashAgentIdentifier">Target DBA Hawk agent for this message</param>
        ...
        private async Task ProcessReply(Message message, Guid handle, string destinationConnectionHash)
        {
            ...
            if (responseMessage.Data != null && responseMessage.Data.Tables.Contains("DBAHawk"))
            {
