...
namespace DBAHawk
{
    public class CollectionConfig : BasicConfig
    {
        ...
        public string ServiceName { get; set; } = "DBAHawkService";
        ...
        public static async Task ValidateDestinationAsync(DBADashConnection destination)
        {
            ...
            else if (destination.Type == ConnectionType.SQL)
            {
                ...
                {
                    throw new Exception("Provide a name for the DBAHawk repository database through the Initial Catalog property of the connection string");
                }
        ...
        private static void ValidateDestinationVersion(DBADashConnection destination)
        {
            ...
            {
                throw new Exception("DBA Hawk repository database requires SQL 2016 SP1 or later");
            }
            ...
            { // Check if we are running SP1 for SQL 2016
                throw new Exception("DBA Hawk repository database requires SQL 2016 SP1 or later.  Please upgrade to SP1 or later.");
            }
        }
