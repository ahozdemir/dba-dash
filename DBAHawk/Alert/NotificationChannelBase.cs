...
using Alert = DBAHawk.Alert.Alert;
...
namespace DBAHawkGUI.DBADashAlerts
{
    public abstract class NotificationChannelBase : IValidatableObject
    {
        ...
        [JsonIgnore]
        [Category("DBA Hawk Notification Channel")]
        ...
        [JsonIgnore]
        [Description("Name of the notification channel for identification purposes in DBA Hawk")]
        ...
        [JsonIgnore]
        [Description("Option to enable/disable notifications when alert is acknowledged in DBA Hawk.")]
