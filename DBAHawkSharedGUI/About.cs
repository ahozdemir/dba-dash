...
namespace DBAHawkGUI
{
    public partial class About : Form
    {
            ...
            try
            {
                ...
                try
                {
                    if (Upgrade.IsUpgradeAvailable(release))
                    {
                        ...
                        {
                            upgradeMessage = "An upgrade is available.  Please upgrade the DBA Hawk service first.";
                        }
                        else
                        {
        ...
        private async void BttnUpgrade_Click(object sender, EventArgs e)
        {
            ...
            if (MessageBox.Show("Run script to upgrade to latest version of DBA Hawk?", "Upgrade", MessageBoxButtons.YesNo, MessageBoxIcon.Question) != DialogResult.Yes)
            {
                return;
            }
            try
