...
namespace DBAHawkGUI.Theme
{
    ...
    public abstract class BaseMenuRenderer : ToolStripProfessionalRenderer
    {
        ...
        public virtual Color MenuBackColor { get; set; } = HawkColors.Gray7;

        public virtual Color MenuForeColor { get; set; } = HawkColors.White;
        public virtual Color ArrowColor { get; set; } = HawkColors.White;
        public virtual Color SeparatorColor { get; set; } = HawkColors.Gray8;

        public virtual Color SelectionColor { get; set; } = HawkColors.HawkBlue;

        public virtual Color SelectionForeColor { get; set; } = HawkColors.White;
