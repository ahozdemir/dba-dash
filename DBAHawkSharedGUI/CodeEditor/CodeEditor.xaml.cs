...
namespace DBAHawkGUI.SchemaCompare
{
    ...
    public partial class CodeEditor : UserControl, IThemedControl
    {
        ...
        private void SetHighlighting()
        {
            ...
            {
                resourceName = "DBAHawkSharedGUI.SyntaxHighlighting.SQL-Dark.xshd";
            }
            else if (mode == CodeEditorModes.SQL)
            {
                resourceName = "DBAHawkSharedGUI.SyntaxHighlighting.SQL-Light.xshd";
            }
            else if (mode == CodeEditorModes.PowerShell)
            {
                resourceName = "DBAHawkSharedGUI.SyntaxHighlighting.PowerShell.xshd";
            }
            ...
            {
                resourceName = "DBAHawkSharedGUI.SyntaxHighlighting.Json.xshd";
            }
