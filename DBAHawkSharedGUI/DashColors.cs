namespace DBAHawkSharedGUI
{
    //https://github.com/datacomware/dba-hawk
    public static class HawkColors
    {
        // Primary
        public static readonly Color HawkBlueDark = Color.FromArgb(0, 79, 131);

        public static readonly Color HawkBlue = Color.FromArgb(0, 99, 163);
        public static readonly Color HawkYellow = Color.FromArgb(251, 173, 38);
        public static readonly Color HawkGray = Color.FromArgb(37, 42, 46);
        ...
        public static readonly Color LinkColor = HawkBlueDark;
        ...
        public static Color DatabaseLevelTitleColor => HawkBlue;
    }
}