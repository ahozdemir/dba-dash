...
namespace DBAHawk.Test
{
    ...
    public class CronParserTests
    {
        ...
        {
            var schedules = new DBAHawkService.CollectionSchedules
            {
                [DBAHawk.CollectionType.CPU] = new DBAHawkService.CollectionSchedule { Schedule = "0 0/1 * * * ?" },
                [DBAHawk.CollectionType.IOStats] = new DBAHawkService.CollectionSchedule { Schedule = "0 * * ? * *" },
                [DBAHawk.CollectionType.Waits] = new DBAHawkService.CollectionSchedule { Schedule = "0 0/1 * * * ?" }
            };
            ...
            CollectionAssert.AreEquivalent(
                new[] { DBAHawk.CollectionType.CPU, DBAHawk.CollectionType.IOStats, DBAHawk.CollectionType.Waits },
